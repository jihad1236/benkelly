...
class NetworkCaller {
  ...
  /// Sends a multipart request. `timeoutSeconds` can be provided to override
  /// the default `timeoutDuration` (useful for large file uploads).
  Future<ResponseData> multipartRequest(
    ...
    try {
      ...
      final streamedResponse = await request.send().timeout(
        Duration(seconds: timeoutSeconds ?? timeoutDuration),
      );
